...
const sidebarVariants = cva(
  "fixed inset-y-0 left-0 z-50 flex w-[300px] flex-col border-r bg-background transition-transform lg:static lg:transition-none",
  {
    variants: {
      open: {
        true: "translate-x-0",
...
export function SidebarFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("border-t bg-background px-4 py-4", className)} {...props} />
}
...
export function SidebarSeparator({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("mx-4 my-4 h-[1px] bg-border", className)} {...props} />
}

export function SidebarRail({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("absolute inset-y-0 right-0 w-[1px] bg-border", className)} {...props} />
}

export function SidebarInset({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("flex flex-1 flex-col lg:pl-[300px]", className)} {...props} />
}
