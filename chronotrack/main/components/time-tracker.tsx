...
export default function TimeTracker() {
  ...
  const [todayTotal, setTodayTotal] = useState("00:00:00")
  ...
  // Mock function to load today's total (would connect to backend later)
  useEffect(() => {
    // This would be replaced with actual data from backend
    setTodayTotal("03:45:12")
  }, [])
  ...
  const handleClockOut = () => {
    // Here we would save the session to local storage or backend
    setState("idle")
    setCurrentSession({
      startTime: null,
      breakStartTime: null,
